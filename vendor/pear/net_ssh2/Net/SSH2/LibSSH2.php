...
class Net_SSH2_LibSSH2 extends Net_SSH2
{
    ...
    public function __construct($options = array())
    {
        if (!function_exists("ssh2_connect")) {
            ...
            throw new Net_SSH2_Exception(
                Net_SSH2::getMessage(self::SSH2_MODULE_NOT_FOUND, $module)
            );
        };
    ...
    public function sshExec(&$std_output, &$std_error, $options = array())
    {
        ...
        try {
            ...
            $stderr_stream = ssh2_fetch_stream($stdout_stream, self::SSH2_STREAM_STDERR);
        } catch (Exception $e) {
    ...
    {
        throw new Net_SSH2_Exception(Net_SSH2::getMessage(self::SSH2_UNSUPPORTED));
    }
    ...
    public function sshCopyId(&$std_output, &$std_error, $options = array())
    {
        ...
        if (!is_readable($this->public_identity_file)) {
            throw new Net_SSH2_Exception(Net_SSH2::getMessage(self::SSH2_PUBLIC_KEY_UNAVAILABLE));
        }
